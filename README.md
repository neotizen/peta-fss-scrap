...
이 저장소에는 Fly 배포용 [Dockerfile](/Users/neotizen/pjt-fss-scrap/Dockerfile)과 [fly.toml](/Users/neotizen/pjt-fss-scrap/fly.toml)이 포함되어 있습니다.

1. [fly.toml](/Users/neotizen/pjt-fss-scrap/fly.toml)의 `app` 값을 원하는 앱 이름으로 수정합니다.
2. `fly auth login`
